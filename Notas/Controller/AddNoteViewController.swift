...
class AddNoteViewController: UIViewController, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if detailNote != nil {
            ...
            noteContent.text = "Aquí va el contenido de tu nota..."
            noteContent.textColor = .systemGray4
        }
    ...
    override func shouldPerformSegue(withIdentifier identifier: String, sender: Any?) -> Bool {
        ...
        guard let title = noteTitle.text, !title.isEmpty,
              ...
              content != "Aquí va el contenido de tu nota..." else {
            ...
            showAlert(message: "Los campos de titulo y nota deben ser obligatorios, por favor completalos o actualiza la información segun el caso.")
            return false
        }
    ...
    func textViewDidBeginEditing(_ textView: UITextView) {
        if textView.text == "Aquí va el contenido de tu nota..." {
            textView.text = ""
